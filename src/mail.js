...
function getMessage(emailParams) {
  return{
    ...
    text: `Hola ${emailParams.customerName}, te enviamos las emágenes de los productos comprados y la factura con número ${email.emailParams.orderNro}. Gracias por tu compra`,
